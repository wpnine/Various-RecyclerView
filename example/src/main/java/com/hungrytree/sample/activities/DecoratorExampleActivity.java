...
import com.hungrytree.sample.items.DecoratorExampleItem;
...
public class DecoratorExampleActivity extends AppCompatActivity {
    ...
    private void initData() {
        mRVDelegation.createTask()
                .attatchItem(new DecoratorExampleItem())
                .attatchItem(new LabelItem(),
                        Arrays.asList(
                                "item 1>>1",
                                "item 1>>2",
                                "item 1>>3",
